...
namespace TimelineWallpaper.Providers {
    public class DaihanProvider : BaseProvider {
        ...
        private Meta ParseBean(Uri uriImg) {
            ...
            meta.Id = name[0];
            meta.Format = "." + name[1];
            meta.Uhd = uriImg.AbsoluteUri.Replace("https://tva4.sinaimg.cn/large", "https://tva4.sinaimg.cn/original/");
            meta.Thumb = uriImg.AbsoluteUri.Replace("https://tva4.sinaimg.cn/large/", "https://tva4.sinaimg.cn/middle/");
