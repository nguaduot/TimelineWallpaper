...
namespace TimelineWallpaper.Providers {
    public class QingbzProvider : BaseProvider {
        ...
        private const string URL_API = "https://api.nguaduot.cn/qingbz?client=timelinewallpaper&cate={0}&order={1}&qc={2}&page={3}";
        ...
        private Meta ParseBean(QingbzApiData bean, string order) {
            ...
            Debug.WriteLine(meta.SortFactor);
            return meta;
        }
